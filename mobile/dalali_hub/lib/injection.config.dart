...
import 'package:dalali_hub/app/pages/auth/bloc/login/login_bloc.dart' as _i39;
import 'package:dalali_hub/app/pages/auth/bloc/logout/logout_bloc.dart' as _i40;
import 'package:dalali_hub/app/pages/auth/bloc/signup/signup_bloc.dart' as _i44;
...
import 'package:dalali_hub/di/app_module.dart' as _i57;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i40.LogoutBloc>(() => _i40.LogoutBloc(
          gh<_i3.AuthCubit>(),
          gh<_i31.IAuthRepository>(),
        ));
    gh.factory<_i41.ProfileBloc>(
        () => _i41.ProfileBloc(gh<_i31.IAuthRepository>()));
    gh.factory<_i42.RequestOtpBloc>(
        () => _i42.RequestOtpBloc(gh<_i31.IAuthRepository>()));
    gh.factory<_i43.ResetPasswordBloc>(
        () => _i43.ResetPasswordBloc(gh<_i31.IAuthRepository>()));
    gh.factory<_i44.SignupBloc>(
        () => _i44.SignupBloc(gh<_i31.IAuthRepository>()));
    gh.factory<_i45.UpdateProfilePhotoBloc>(
        () => _i45.UpdateProfilePhotoBloc(gh<_i31.IAuthRepository>()));
    gh.factory<_i46.UpdateRealstateBloc>(
        () => _i46.UpdateRealstateBloc(gh<_i35.IRealstateRepository>()));
    gh.factory<_i47.UpdateVehicleBloc>(
        () => _i47.UpdateVehicleBloc(gh<_i37.IVehicleRepository>()));
    gh.factory<_i48.VerifyOtpBloc>(
        () => _i48.VerifyOtpBloc(gh<_i31.IAuthRepository>()));
    gh.factory<_i49.AddImagesBloc>(
        () => _i49.AddImagesBloc(gh<_i33.IImagesRepository>()));
    gh.factory<_i50.CreateRealstateBloc>(
        () => _i50.CreateRealstateBloc(gh<_i35.IRealstateRepository>()));
    gh.factory<_i51.CreateVehicleBloc>(
        () => _i51.CreateVehicleBloc(gh<_i37.IVehicleRepository>()));
    gh.factory<_i52.DeleteImageBloc>(
        () => _i52.DeleteImageBloc(gh<_i33.IImagesRepository>()));
    gh.factory<_i53.DeleteRealstateBloc>(
        () => _i53.DeleteRealstateBloc(gh<_i35.IRealstateRepository>()));
    gh.factory<_i54.DeleteVehicleBloc>(
        () => _i54.DeleteVehicleBloc(gh<_i37.IVehicleRepository>()));
    gh.factory<_i55.FilterRealstateBloc>(
        () => _i55.FilterRealstateBloc(gh<_i35.IRealstateRepository>()));
    gh.factory<_i56.FilterVehicleBloc>(
        () => _i56.FilterVehicleBloc(gh<_i37.IVehicleRepository>()));
    return this;
  }
}
