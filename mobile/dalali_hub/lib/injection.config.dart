...
import 'package:dalali_hub/app/pages/auth/bloc/login/login_bloc.dart' as _i23;
import 'package:dalali_hub/app/pages/auth/bloc/logout/logout_bloc.dart' as _i24;
import 'package:dalali_hub/app/pages/auth/bloc/signup/signup_bloc.dart' as _i27;
...
import 'package:dalali_hub/data/remote/client/auth_client.dart' as _i18;
import 'package:dalali_hub/data/remote/client/house_client.dart' as _i13;
import 'package:dalali_hub/data/remote/client/user_client.dart' as _i17;
import 'package:dalali_hub/data/remote/config/network_config.dart' as _i5;
import 'package:dalali_hub/data/repository/auth_repository.dart' as _i22;
import 'package:dalali_hub/data/repository/house_repository.dart' as _i15;
import 'package:dalali_hub/di/app_module.dart' as _i29;
import 'package:dalali_hub/domain/config/network_config.dart' as _i4;
import 'package:dalali_hub/domain/repository/auth_repository.dart' as _i21;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i16.UpdateHouseBloc>(
        () => _i16.UpdateHouseBloc(gh<_i14.IHouseRepository>()));
    gh.singleton<_i17.UserClient>(appModule.userClient(gh<_i12.Dio>()));
    gh.singleton<_i18.AuthClient>(appModule.authClient(gh<_i12.Dio>()));
    gh.factory<_i19.CreateHouseBloc>(
        () => _i19.CreateHouseBloc(gh<_i14.IHouseRepository>()));
    gh.factory<_i20.DeleteHouseBloc>(
        () => _i20.DeleteHouseBloc(gh<_i14.IHouseRepository>()));
    gh.lazySingleton<_i21.IAuthRepository>(() => _i22.AuthRepository(
          gh<_i18.AuthClient>(),
          gh<_i9.SharedPreference>(),
        ));
    ...
    gh.factory<_i24.LogoutBloc>(() => _i24.LogoutBloc(
          gh<_i3.AuthCubit>(),
          gh<_i21.IAuthRepository>(),
        ));
    gh.factory<_i25.RequestOtpBloc>(
        () => _i25.RequestOtpBloc(gh<_i21.IAuthRepository>()));
    gh.factory<_i26.ResetPasswordBloc>(
        () => _i26.ResetPasswordBloc(gh<_i21.IAuthRepository>()));
    gh.factory<_i27.SignupBloc>(
        () => _i27.SignupBloc(gh<_i21.IAuthRepository>()));
    gh.factory<_i28.VerifyOtpBloc>(
        () => _i28.VerifyOtpBloc(gh<_i21.IAuthRepository>()));
    return this;
  }
}
