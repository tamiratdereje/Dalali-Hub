...
import 'package:dalali_hub/app/core/auth/bloc/auth_bloc.dart' as _i8;
import 'package:dalali_hub/app/core/auth/cubit/auth_cubit.dart' as _i3;
import 'package:dalali_hub/app/navigation/navigator.dart' as _i6;
...
import 'package:dalali_hub/app/pages/property_filter/bloc/filter_vehicle/filter_vehicle_bloc.dart'
    as _i51;
import 'package:dalali_hub/data/local/pref/pref.dart' as _i7;
...
import 'package:dalali_hub/data/remote/config/network_config.dart' as _i10;
...
import 'package:dalali_hub/domain/config/network_config.dart' as _i9;
...
import 'package:dalali_hub/util/log_interceptor.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i4.LogInterceptor>(_i4.LogInterceptor());
    await gh.factoryAsync<_i5.SharedPreferences>(
      () => appModule.prefs,
      preResolve: true,
    );
    gh.factory<_i6.AppRouter>(() => _i6.AppRouter(gh<_i3.AuthCubit>()));
    gh.factory<_i7.SharedPreference>(
        () => _i7.SharedPreference(gh<_i5.SharedPreferences>()));
    gh.factory<_i8.AuthBloc>(() => _i8.AuthBloc(
          gh<_i3.AuthCubit>(),
          gh<_i7.SharedPreference>(),
        ));
    gh.factory<_i9.INetworkConfig>(
        () => _i10.NetworkConfig(gh<_i7.SharedPreference>()));
    gh.factory<_i11.JwtInterceptor>(
        () => _i11.JwtInterceptor(pref: gh<_i7.SharedPreference>()));
    gh.singleton<_i12.Dio>(appModule.dio(
      gh<_i9.INetworkConfig>(),
      gh<_i4.LogInterceptor>(),
