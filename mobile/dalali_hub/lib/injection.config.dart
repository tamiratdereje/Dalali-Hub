...
import 'package:dalali_hub/app/core/auth/bloc/auth_bloc.dart' as _i18;
...
import 'package:dalali_hub/app/pages/auth/bloc/login/login_bloc.dart' as _i16;
import 'package:dalali_hub/app/pages/auth/bloc/logout/logout_bloc.dart' as _i17;
import 'package:dalali_hub/data/local/pref/pref.dart' as _i9;
import 'package:dalali_hub/data/remote/client/auth_client.dart' as _i13;
import 'package:dalali_hub/data/remote/client/user_client.dart' as _i12;
import 'package:dalali_hub/data/remote/config/network_config.dart' as _i5;
import 'package:dalali_hub/data/repository/auth_repository.dart' as _i15;
import 'package:dalali_hub/di/app_module.dart' as _i19;
import 'package:dalali_hub/domain/config/network_config.dart' as _i4;
import 'package:dalali_hub/domain/repository/auth_repository.dart' as _i14;
import 'package:dalali_hub/util/jwt_interceptor.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i10.JwtInterceptor>(
        () => _i10.JwtInterceptor(pref: gh<_i9.SharedPreference>()));
    gh.singleton<_i11.Dio>(appModule.dio(
      gh<_i4.INetworkConfig>(),
      gh<_i6.LogInterceptor>(),
      gh<_i10.JwtInterceptor>(),
    ));
    gh.singleton<_i12.UserClient>(appModule.userClient(gh<_i11.Dio>()));
    gh.singleton<_i13.AuthClient>(appModule.authClient(gh<_i11.Dio>()));
    gh.lazySingleton<_i14.IAuthRepository>(
        () => _i15.AuthRepository(gh<_i13.AuthClient>()));
    gh.factory<_i16.LoginBloc>(() => _i16.LoginBloc(
          gh<_i14.IAuthRepository>(),
          gh<_i3.AuthCubit>(),
        ));
    gh.factory<_i17.LogoutBloc>(() => _i17.LogoutBloc(
          gh<_i3.AuthCubit>(),
          gh<_i14.IAuthRepository>(),
        ));
