...
class _$SendMessageImpl implements _SendMessage {
  const _$SendMessageImpl(this.roomId, this.message);
  ...
  @override
  String toString() {
    return 'SendMessageEvent.sendMessage(roomId: $roomId, message: $message)';
  }
...
abstract class _SendMessage implements SendMessageEvent {
  const factory _SendMessage(final String roomId, final String message) =
      _$SendMessageImpl;
