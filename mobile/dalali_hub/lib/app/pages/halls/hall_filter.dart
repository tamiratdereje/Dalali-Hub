...
import 'package:dalali_hub/app/pages/halls/widgets/hall_card.dart';
...
class HallFilter extends StatefulWidget {
  ...
  const HallFilter({super.key, required this.serviceName});

  @override
  State<HallFilter> createState() => _HallFilterState();
}

class _HallFilterState extends State<HallFilter> {
