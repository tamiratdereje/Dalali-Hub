...
mixin _$GetMyStatState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(BrokerStat feeds) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(BrokerStat feeds)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(this.feeds);

  @override
  final BrokerStat feeds;

  @override
  String toString() {
    return 'GetMyStatState.success(feeds: $feeds)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, feeds);
...
abstract class _Success implements GetMyStatState {
  const factory _Success(final BrokerStat feeds) = _$SuccessImpl;

  BrokerStat get feeds;
  @JsonKey(ignore: true)
  _$$SuccessImplCopyWith<_$SuccessImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
